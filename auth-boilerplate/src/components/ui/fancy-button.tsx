...
export const fancyButtonVariants = tv({
  slots: {
    root: [
      "group relative inline-flex items-center justify-center whitespace-nowrap text-label-sm outline-none transition duration-200 ease-out",
      "focus:outline-none",
  ...
  variants: {
    variant: {
      neutral: { root: "bg-bg-strong-950 text-text-white-0 shadow-fancy-buttons-neutral" },
      primary: { root: "bg-primary-base text-static-white shadow-fancy-buttons-primary" },
      secondary: { root: "bg-gray-50 text-text-sub-600 shadow-fancy-buttons-stroke hover:bg-bg-weak-50 hover:text-text-strong-950" },
      destructive: { root: "bg-error-base text-static-white shadow-fancy-buttons-error" },
      basic: { root: "bg-bg-white-0 text-text-sub-600 shadow-fancy-buttons-stroke hover:bg-bg-weak-50 hover:text-text-strong-950 hover:shadow-none" },
    },
    size: {
      medium: { root: "h-10 gap-3 rounded-10 px-3.5", icon: "-mx-1" },
      small: { root: "h-9 gap-3 rounded-lg px-3", icon: "-mx-1" },
      xsmall: { root: "h-8 gap-3 rounded-lg px-2.5", icon: "-mx-1" },
    },
  },
  compoundVariants: [{
    variant: ["neutral", "primary", "secondary", "destructive"],
    class: {
      root: [
  ...
  defaultVariants: { variant: "neutral", size: "medium" },
});
